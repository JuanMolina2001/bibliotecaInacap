...
def DefUsuario(hacer_prestamo):
    while True :
        ...
        if tipo == "docente": 
            diasDevolucion = 20 #cantidad dias para devolver el libro docente
            break
        elif tipo == "estudiante":
            cantidad_Prestamo = cantidadPrestamo(rut)
            if cantidad_Prestamo == 4: #cantidad de prestamos disponibles estudiante
                ...
                diasDevolucion = 7 #cantidad dias para devolver el libro estudiante
                break
    return diasDevolucion, rut 
...
def mostrarPrestamos():
    ...
    headers = ['Nombre', 'Apellido', 'Titulo', 'Fecha prestamo', 'Fecha devolucion','Estado']
...
def buscarPrestamo():
    ...
    headers = ['id prestamo', 'rut', 'id ejemplar', 'Nombre', 'Apellido', 'Titulo', 'Fecha prestamo', 'fecha devolucion','estado',]
...
def menu_prestamo():
    while True:
        ...
        print("2. Mostrar los prestamos")
        print("3. Buscar un prestamo")
        print("4. Salir")
        opcion = input_int("Selecciona una opción: ")
        if opcion == 1:
            crearPrestamo()
